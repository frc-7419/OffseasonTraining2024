...
public class ShooterSubsystem extends SubsystemBase {
  ...
  /**
   * Runs the shooter at the given power
  ...
  public void periodic() {
    SmartDashboard.putNumber("Top shooter motor volatage", topMotor.getMotorVoltage().getValue());
    SmartDashboard.putNumber("Bottom shooter motor volatage", bottomMotor.getMotorVoltage().getValue());
  }
}