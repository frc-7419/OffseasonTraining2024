...
public class ArcadeDrive extends SubsystemBase {
  ...
  public double getCurrentPosition() {
    // Assuming you have encoders set up for each motor
    // This method should return the average position of the left and right sides
    double leftPosition = leftLeader.getRotorPosition().getValueAsDouble();
    double rightPosition = rightLeader.getRotorPosition().getValueAsDouble();
    return (leftPosition + rightPosition) / 2; // Average position
  }
